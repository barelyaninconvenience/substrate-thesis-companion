...
*[Draft ¶4]* The framework we present treats this as a structural problem with a structural solution. We articulate the three patterns formally (§3), demonstrate them via six case studies spanning artifact reinvigoration, framework evolution, audit cadence design, cross-domain architecture reuse, and longitudinal personal-OS evolution (§4), catalog named anti-patterns with documented failure modes and mitigations (§5), and present preliminary cross-practitioner convergence evidence where independent practitioners have arrived at structurally-identical conventions through what we argue is convergent design rather than social diffusion (§4 case C + §6 discussion). We close with implications for HCI design, AI-augmented workflow tooling, and personal informatics research (§6), and honest acknowledgment of limitations (§7).
...
- Initial cross-practitioner evidence of pattern emergence in independent practitioners (N=2 confirmed; prevalence study in progress; §7.2 future work)
...
- **Konrad et al. (2026a, arXiv 2601.18341) — "Agentic Much? Adoption of Coding Agents on GitHub"** N=129,134 projects studied; 15.85%-22.60% adoption rate; broad across maturity/languages/orgs. Empirical scale-study without structural taxonomy. Full differentiation analysis at `docs/differentiation_vs_konrad_2601_18341_20260425.md`.
- **Konrad et al. (2026b, arXiv 2604.04990) — "Architecture Without Architects: How AI Coding Agents Shape Software Architecture"** position paper introducing **"vibe architecting"** — architecture shaped by prompts rather than deliberate design. Five mechanisms by which agents make implicit architectural choices; six prompt-architecture coupling patterns spanning contingent (may weaken as models improve) to fundamental (persists regardless of capability). **Disambiguation note:** SAME first-author Phongsakon Mark Konrad as 2601.18341. Cite as 2026a / 2026b throughout. Full differentiation analysis at `docs/differentiation_vs_konrad_arch_2604_04990_20260425.md`. **Names the failure mode the Substrate Thesis structural framework prevents.**
...
These two projects strengthen Case Study C (cross-practitioner convergence) substantially: alongside Daniel Miessler's Substrate framework (Category 0 vocabulary-collision documented in `docs/prior_art_survey.md` Category 0), the mempalace + doobidoo entries provide **two independent existence proofs of axiomatic (not just lexical) convergence**. Case Study C's N is now N=3+ confirmed instances (the author's stack + Miessler vocabulary-overlap + mempalace 6/7-axiom-mirror + doobidoo direct-rule-transfer). The N=2 limitation acknowledged in the original outline is partially addressed; the prevalence study (§7.2 item 1) is the path to formal-N quantification but the Category 5 entries already provide qualitative-evidence sufficient for §4.3 case study C strengthening.
...
- Konrad, P. M., Adam, T. L., Terrenzi, R., & Ayvaz, S. 2026b. *Architecture Without Architects: How AI Coding Agents Shape Software Architecture.* arXiv 2604.04990.
