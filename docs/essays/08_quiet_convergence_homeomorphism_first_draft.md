...
*Essay 8 first draft, authored 2026-04-30. Updated 2026-05-01 evening to incorporate (a) Anthropic Skills as the sixth practitioner-case (promoted Cat-4 → Cat-6 in `prior_art_survey.md §6.3` following code-level audit); (b) Anthropic Cookbooks Cat-5 anchor in §3 implications (see `prior_art_survey.md §5.9`); (c) Roynard's 4-layer cognitive-architecture paper (arxiv 2604.11364) as independent academic-literature detection of the same convergence pattern with explicit "eight convergence points" framing (see `bibliography.md §A.7` and `prior_art_survey.md §5.10`); (d) verified N=18 evidence-base citation. Substack-ready voice; CHI-citation-ready content. The six-case practitioner-convergence + verified-academic-anchor reading is load-bearing for the Substrate Thesis's central architectural claim.*
